...
const Home = () => {
  return (
  <div className=" min-h-screen flex felx-col justify-center lg:flex-row lg:justify-between items-center lg:px-32 px-5 gap-10 bg-gradient-to-r from-backgroundColor to-brightColor">
    <div className=" w-full lg:w-2/4 space-y-4 mt-14 lg:mt-0">
        <h1 className=" font-semibold text-5xl text-center lg:text-start leading-tight">
          Start your day with a<br/> steaming cup of<br/> coffee
          </h1>
        <p>
          Boost your productivity and build your mood with a glass of <br/>coffee in the morning
          </p>
