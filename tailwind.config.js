...
export default {
  ...
  safelist: [
    ...
    "origin-left transition-transform group-hover:scale-x-100 group relative inline-block  hover:text-blue-400",
    ...
    "px-3 text-sm px-6 py-1 border-2 border-white bg-[#FFDCAB]  hover:text-brightColor transition-all rounded-full",
  ],
  theme: {
    extend: {
      colors: {
